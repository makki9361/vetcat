                    ...
                    <div class="bl element-animation">
                        <div class="letter">
                            <?php foreach ($model1 as $a): ?>
                                <a class="first" href="<?php echo \yii\helpers\Url::to(['site/vetss', 'id' => $a->id])?>"><?= $a->name ?></a>
                            <?php endforeach; ?>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="search_vet">
                        ...
                        <?= ListView::widget([
                            ...
                            'itemView' => function ($model, $key, $vets, $widget) {
                                return Html::a(Html::encode($model->first_name . ' ' . $model->second_name . ' ' . $model->last_name .  ' ' . Post::find()->where(['id' => $model->post_id])->one()->name), ['view', 'id' => $model->id]);
                            },
                        ]) ?>
                    </div>
                    <div class="trud">
